 ...
 */
if ( ! defined( 'WPB_VC_VERSION' ) ) define( 'WPB_VC_VERSION', '99' );
/**
...
class Vc_Manager {
	 ...
	 * @var array
	 */
	private $editor_default_post_types = array('page','pirenko_portfolios','post','pirenko_team_member'); // TODO: move to Vc settings
	/**
	...
	function __construct() {
		...
		$this->setPaths( Array(
			...
			'APP_DIR' => basename( $dir ) . '/fount_framework/js_composer-fount/',
	...
	public function assetUrl( $file ) {
		...
		return plugins_url() .'/fount_framework/js_composer-fount/'. $this->path( 'ASSETS_DIR_NAME', $file );
	}
}
/**
