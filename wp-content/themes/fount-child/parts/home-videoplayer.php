<section class="hero hero-slide">
    <div class="row_pattern_overlay" style="background-image:url(http://northeast.dev/wp-content/themes/fount/images/overlays/dots.png);"></div>
    <div class="video-hero-embed">
    <div class="wpb_wrapper">
			<div class="clearfix" style="height:250px;"></div><div class="prk_shortcode-title fount_centered_text wpb_animate_when_almost_visible wpb_appear h1_sized double_lined wpb_start_animation"><div class="header_font zero_color prk_vc_title" style="color:#ffffff;border-bottom-color:rgba(255, 255, 255,0.9);text-shadow:0px 0px 1px rgba(255, 255, 255,0.2);"><h1>Bring out your adventurous side!</h1></div><div class="clearfix"></div></div><div class="prk_shortcode-title fount_centered_text wpb_animate_when_almost_visible wpb_appear h2_sized wpb_start_animation"><div class="header_font zero_color prk_vc_title" style="color:#ffffff;border-bottom-color:rgba(255, 255, 255,0.9);text-shadow:0px 0px 1px rgba(255, 255, 255,0.2);"><h2>The best ATV and Side-by-Side Rental<br>
