                            ...
                            if (has_post_thumbnail( $post->ID ) )
                            {
                                ...
                                <div class="item">
                                    <div class="blog_top_image boxed_shadow">
                                        ...
                                        ?>
                                        <img src="<?php echo esc_attr($vt_image['url']); ?>" width="<?php echo esc_attr($vt_image['width']); ?>" height="<?php echo esc_attr($vt_image['height']); ?>" id="home_fader-<?php the_ID(); ?>" class="custom-img grid_image boxed_shadow" alt="" />
                                    </div>
                                </div>
                                <?php
                            }
