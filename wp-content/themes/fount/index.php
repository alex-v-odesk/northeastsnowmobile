<?php 
   ...
   if ($prk_fount_options['archives_type']=="masonry") //MASONRY LAYOUT ----------------------------+++----------------------------
    ...
    <div id="main_block" class="page-<?php echo get_the_ID(); ?>">
        ...
        ?>
        <div class="clearfix bt_15gutter"></div>
        <div id="content">
            <div id="main" class="<?php echo $extra_space; ?>">
                    ...
                    <?php
                        ...
                        else
                        {
                            ...
                            $post_counter=($paged-1)*$posts_per_page;
                                ...
                                ?>
                                <div class="templated masonry_blog per_init prk_section clearfix" data-max-width="<?php echo $iso_images_max_w; ?>" data-min-width="<?php echo $iso_images_min_w; ?>" data-margin="<?php echo $thumbs_margin; ?>">
                                    <?php
                                    while ($my_query->have_posts()) : $my_query->the_post(); 
                                        ...
                                        ?>
                                        <div id="post-<?php the_ID(); ?>" class="<?php echo $featured_class; ?> blog_entry_li clearfix<?php if ($post_counter == $my_query->post_count) echo " last_li"; ?>" data-type="<?php $category= get_the_category();
                ...
                <?php 
                   ...
                   //APPLY FILTERS FOR CATEGORY IF NEEDED
                    ...
                    echo '<ul id="blog_entries" class="unstyled">';
                      ...
                      ?>
                    <li id="post-<?php the_ID(); ?>" class="<?php echo $featured_class; ?>blog_entry_li clearfix prk_inner_block small-twelve columns small-centered" data-color="<?php echo $featured_color; ?>">
