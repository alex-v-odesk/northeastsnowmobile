...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
    ...
    class TGM_Plugin_Activation {
        ...
        public function notices() {
            ...
            if ( get_user_meta( get_current_user_id(), 'tgmpa_dismissed_notice', true )==$my_theme->get('Version')) {
                return;
            }
        ...
        public function dismiss() {
            ...
            if ( isset( $_GET['tgmpa-dismiss'] ) ) {
                //PIRENKO
                $my_theme = wp_get_theme();
                update_user_meta( get_current_user_id(), 'tgmpa_dismissed_notice', $my_theme->get('Version') );
            }
