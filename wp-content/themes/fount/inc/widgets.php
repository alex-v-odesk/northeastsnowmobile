...
function fount_widgets_init() {
    ...
    register_sidebar(array(
        ...
        'before_title' => '<div class="widget-title header_font bd_headings_text_shadow zero_color prk_heavier_600">',
    ...
    register_sidebar(array(
        ...
        'before_widget' => '<div id="%1$s" class="widget %2$s vertical_widget"><div class="widget_inner">',
        'after_widget' => '</div><div class="clearfix"></div></div>',
        'before_title' => '<div class="widget-title not_zero_color header_font">',
        'after_title' => '</div><div class="clearfix"></div>',
    ));
    register_sidebar(array(
...
add_action('widgets_init', 'fount_widgets_init');
...
function ups_sidebar_do_meta_box( $post, $metabox ) {
    ...
    ?>
    <div class="wp-tab-wrapper left_floated pct_25 prkadmin_hide_now">
        <ul class="wp-tab-bar">
    ...
    if ( isset( $input['add_sidebar'] ) ) { 
        ...
        if ( ! empty( $input['add_sidebar'] ) ) {
            ...
            $sidebars['ups-sidebar-' . $sidebar_num] = array(
                ...
                'description' => '',
                'before_widget' => '<div id="%1$s" class="widget %2$s columns vertical_widget"><div class="widget_inner">',
                'after_widget' => '</div></div>',
                'before_title' => '<div class="widget-title header_font bd_headings_text_shadow zero_color prk_heavier_600">',
                'after_title' => '</div>',
                'pages' => array(),
