<?php
	...
	define('SIDEBAR_CLASSES',           'small-3 columns');	
	...
	define('PRK_BACKEND_THEME_NAME',		'fount');
	define('ACF_LITE',false);
	
	$remote_version_url=ABSPATH . 'wp-content/plugins/color-manager-fount/style_header.php';
	define('INJECT_STYLE',				@fopen($remote_version_url, "r"));

	include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
	if (is_plugin_active('fount_framework/fount_framework.php')) 
	{
    	define('PRK_FOUNT_FRAMEWORK',"true");
    }
    else
    {
